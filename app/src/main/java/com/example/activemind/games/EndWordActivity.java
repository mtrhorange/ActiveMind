...
public class EndWordActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        playAgainBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                finish();
                Intent intent = new Intent(EndWordActivity.this, NumberMemoryActivity.class);
                intent.putExtra("catId","Number Game");
                EndWordActivity.this.startActivity(intent);
            }
        });
    }
}